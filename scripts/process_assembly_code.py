...
with open(os.path.join(output_dir, "codigo_maquina.txt"), "r") as fd:
...
result_path = os.path.join(output_dir, "final_code.X68")
with open(result_path, "w") as fd:
    fd.write(final_code)

if os.path.exists(k68_dir):
    k68_file = os.path.join(k68_dir, "final_code.X68")
